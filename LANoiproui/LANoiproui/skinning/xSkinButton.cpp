...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButton::SetSkin(LPCTSTR  lpszNormal,LPCTSTR lpszDown,LPCTSTR lpszOver,LPCTSTR lpszDisabled, LPCTSTR lpszFocus,LPCTSTR  lpszMask,
				  short drawmode, short border, short margin)
{
	...
	if (lpszNormal!=NULL) m_bNormal.Attach(LoadBmpFromFile(lpszNormal));
	if (lpszDown!=NULL)	  m_bDown.Attach(LoadBmpFromFile(lpszDown));
	if (lpszOver!=NULL)	  m_bOver.Attach(LoadBmpFromFile(lpszOver));
	if (lpszFocus!=NULL)  m_bFocus.Attach(LoadBmpFromFile(lpszFocus));

	if (lpszDisabled!=NULL) m_bDisabled.Attach(LoadBmpFromFile(lpszDisabled));
	else if (lpszNormal!=NULL) m_bDisabled.Attach(LoadBmpFromFile(lpszNormal));
	...
	if (lpszMask!=NULL){
		m_bMask.Attach(LoadBmpFromFile(lpszMask));
